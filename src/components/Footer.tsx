...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-black text-white pt-32 pb-8 w-full relative">
      {/* Wave SVG */}
      <div
      ...
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <button
          onClick={scrollToTop}
          className="bg-green-600 hover:bg-green-700 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-green-500/30 group"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="animate-fadeIn">
            <div className="bg-white p-3 rounded-lg inline-block mb-6 shadow-lg transform hover:rotate-3 transition-transform duration-300">
              <img
                src="https://uploadthingy.s3.us-west-1.amazonaws.com/21Zr7WGS5gfPu7FJ7DnhuJ/Logo.png"
                alt="Ceylon Tour Bird"
                className="h-16"
              />
            </div>
            ...
            <div className="flex space-x-4 rtl:space-x-reverse">
              <a
                href="#"
                className="bg-gray-800 hover:bg-green-600 text-white p-3 rounded-full transition-colors duration-300 transform hover:scale-110"
                aria-label="Facebook"
              >
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="text-gray-400 inline-block hover:text-white transition-colors duration-300"
                >
              ...
              <li>
                <a
                  href="#destinations"
                  onClick={(e) => navigateTo('destinations', e)}
                  className="text-gray-400 inline-block hover:text-white transition-colors duration-300"
                >
                  <span className="border-b border-transparent hover:border-green-500 pb-1">
                    {t('destinations')}
              ...
              <li>
                <a
                  href="#inquiry"
                  onClick={(e) => navigateTo('inquiry', e)}
                  className="text-gray-400 inline-block hover:text-white transition-colors duration-300"
                >
                  <span className="border-b border-transparent hover:border-green-500 pb-1">
                    {t('inquiry')}
          ...
          >
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center space-x-3 rtl:space-x-reverse group">
                ...
                <a
                  href="mailto:info@ceylontourbird.com"
                  className="text-gray-400 hover:text-white transition-colors duration-300"
                >
            ...
            <div className="mt-8 pt-6 border-t border-gray-800">
              <a
                ...
                className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-6 py-3 rounded-md font-medium transition-all duration-300 hover:scale-105 inline-flex items-center shadow-lg shadow-green-900/20"
              >
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 text-center">
          ...
          <p className="text-gray-500 text-sm mt-3 animate-fadeIn flex items-center justify-center">
            {t('made_with')}{' '}
            <HeartIcon
              className="h-4 w-4 text-red-500 mx-1 animate-pulse"
              style={{
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-20 left-10 w-2 h-2 bg-green-500 rounded-full animate-float"
          style={{
            animationDuration: '7s',
          }}
        ></div>
        <div
          className="absolute top-40 right-20 w-3 h-3 bg-blue-500 rounded-full animate-float"
          style={{
            animationDuration: '5s',
          }}
        ></div>
        <div
          className="absolute bottom-40 left-30 w-2 h-2 bg-yellow-500 rounded-full animate-float"
          style={{
            animationDuration: '8s',
          }}
        ></div>
        <div
          className="absolute bottom-20 right-40 w-3 h-3 bg-purple-500 rounded-full animate-float"
          style={{
